...
ProducerConfig.ENABLE_IDEMPOTENCE_CONFIG = "enable.idempotence";            // включение проверки сообщений перед записью на идемпотентность (true|false)
...
public class KafkaConfiguration {
    ...
    NewTopic createTopic() {
        return TopicBuilder.name("product-created-events-topic")
          ...
          .configs(Map.of("min.insync.replicas", "2")) // минимальное кол-во 2 сервера в синхронизации с лидером 
            // (параметр Isr при вызове команды --describe из консоли)
